...
type ViewHistory struct {
	...
	UserID    string    `gorm:"not null;index:idx_t_view_history_user_id;column:user_id;size:64" json:"-"` // 关联 t_auth_user.id
	RecipeID  string    `gorm:"not null;index:idx_t_view_history_recipe_id;column:recipe_id;size:64" json:"recipe_id"`
