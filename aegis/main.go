...
import (
	...
	"github.com/heliannuuthus/helios/aegis/internal/auth"
	aegisconfig "github.com/heliannuuthus/helios/aegis/internal/config"
	"github.com/heliannuuthus/helios/aegis/internal/middleware"
	hermes "github.com/heliannuuthus/helios/aegis/internal/rpc/hermes"
...
func main() {
	...
	aegisHandler, err := auth.Initialize(client, client, credentialSvc)
	if err != nil {
	...
	irisGuard := guard.NewGin(aegisconfig.GetIrisAegisAudience())
